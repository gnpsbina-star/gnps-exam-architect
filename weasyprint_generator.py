# To run this script, ensure you have weasyprint installed:
...
def generate_cbse_papers():
    try:
        # Generate SET A
        print("Rendering Class_11_Unit_Test_III_English_Core_301_Set_A.pdf...")
        HTML(string=set_a_html).write_pdf(
            "Class_11_Unit_Test_III_English_Core_301_Set_A.pdf",
            stylesheets=[CSS(string=cbse_css + footer_css_set_a)]
        )
        
        # Generate SET B
        print("Rendering Class_11_Unit_Test_III_English_Core_301_Set_B.pdf...")
        HTML(string=set_b_html).write_pdf(
            "Class_11_Unit_Test_III_English_Core_301_Set_B.pdf",
            stylesheets=[CSS(string=cbse_css + footer_css_set_b)]
        )
        
        print("Success! Both CBSE compliant PDF files have been generated.")
