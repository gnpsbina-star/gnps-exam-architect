...
CURRICULUM_UPDATES = [
    ...
    ("2026-27-class11-12-humanities-chapters", [(cls, subj) for cls in ("Class 11", "Class 12")
                                                for subj in ("History", "Political Science", "Geography",
                                                             "Sociology", "Informatics Practices")]),
]
